...
define([
    ...
    var Collection = Backbone.Collection.extend({
        ...
        initialize: function(categoryId, options){
            ...
            // define dynamically url to get data
            this.url = '/lullaby/category/' + categoryId;
            ...
            product.urlRoot = 'lullaby/category/count/' + categoryId;
            product.fetch({
                success: function(response) {
                    self.countProducts = response.attributes.count;
